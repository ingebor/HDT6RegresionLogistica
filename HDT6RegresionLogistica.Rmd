...
confusionMatrix(as.factor(test$datosCasasIntermedias),as.factor(prediccion))
```
Debido a los altos valores de accuracy se decidió hacer un análisis de multicolinealidad con el objetivo de observar si hay algún componente "arrastrando" los valores causando sobreajuste 
...
borrar <- c("X1stFlrSF","TotRmsAbvGrd","GarageArea")
